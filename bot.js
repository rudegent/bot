...
var bot_token = '6838129759:AAHcaVSeW_RrOEOlInysMamjhFcLTYiO4VQ'; //YOUR BOT TOKEN HERE

var bot_name = 'hasdigitsbot'; // Bot Name
...
const admin_id = 7095400963;

const admin_id2 = 
    ;

var mongo_url = 'mongodb+srv://taphash:<Sailor52>@taphash.ouqs12q.mongodb.net/?retryWrites=true&w=majority&appName=taphash'; // Your Mongo URL Here
...
bot.hears(/^\/start (.+[1-9]$)/, async (ctx) => {
    ...
    try {
        ...
        if (admin.length == 0) {
            ...
            db.collection('admindb').insertOne({ admin: "admin", ref: 1, cur: 'USD', paychannel: '@paymentstats', bonus: 0.25, minimum: 20, botstat: 'Active', withstat: 'ON', subwallet: 'NOT SET', MKEY: 'NOT SET', MID: 'NOT SET', channels: [] })
